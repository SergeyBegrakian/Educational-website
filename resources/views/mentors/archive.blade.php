...
<div >
        ...
        <div class="card-body" style="width: 1360px !important;">
                        <a href="/admin/mentors"   class="login" title="Add New Contact">
                            <i  ></i>Mentors</a>
                <div class="card">
                    <div class="card-body" style="width: 1360px !important;">
                            ...
                            <table class="table" style="width: 1360px !important;" >
                                ...
                                @foreach($mentors as $mentor)
                                    ...
                                    <td> <a href="/{{$mentor->slug}}">
                                        ...
                                        <td>
                                            <form action="/admin/mentors/deleteArchive/{{$mentor->id}}" method="POST" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                                <input name="_method" type="hidden" value="DELETE">
                                                <button type="submit" class="login show_confirm" data-toggle="tooltip" title='Delete'>Delete</button>
                                            </form>
                                            <form action="/admin/mentors/restore/{{$mentor->id}}" method="POST" accept-charset="UTF-8" style="display:inline">
                                            {{csrf_field()}}
                                            {{ method_field('PUT') }}
                                                <input name="_method" type="hidden">
                                                <a href="/admin/mentors/restore/{{$mentor->id}}" class="login show_confirm" data-toggle="tooltip" title='Delete'>Restore</a>
                                            </form>
