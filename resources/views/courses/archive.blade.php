...
<div >
        ...
        <div class="card-body" style="width: 1360px !important;">
                        <a href="/admin/courses"   class="login" title="Add New Contact">
                            <i  ></i>Courses</a>
                <div class="card">
                    <div class="card-body" style="width: 1360px !important;">
                            ...
                            <table class="table" style="width: 1360px !important;" >
                                ...
                                @foreach($courses as $course)
                                    ...
                                    <td> <a href="/{{$course->slug}}">
							                        <img src="{{ asset('images/' . $course->image_path)}}" style="width:135px; height:120px; border-radius:100px;">
						                              </a>          
                                        </td> 
                                        <td>{{ $course->id}}</td> 
                                        <td>{{ $course->title}}</td> 
                                        ...
                                        <td>
                                            <form action="/admin/courses/deleteArchive/{{$course->id}}" method="POST" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                                <input name="_method" type="hidden" value="DELETE">
                                                <button type="submit" class="login show_confirm" data-toggle="tooltip" title='Delete'>Delete</button>
                                            </form>
                                            <form action="/admin/courses/restore/{{$course->id}}" method="POST" accept-charset="UTF-8" style="display:inline">
                                            {{csrf_field()}}
                                            {{ method_field('PUT') }}
                                                <input name="_method" type="hidden">
                                                <a href="/admin/courses/restore/{{$course->id}}" class="login show_confirm" data-toggle="tooltip" title='Delete'>Restore</a>
                                            </form>
