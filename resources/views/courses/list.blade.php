        ...
        <div class=col-xl-12>
          <nav class="navbar navbar-expand-lg">
            <a class=navbar-brand href="/">
              <img id=logo  src="{{ asset('/assets/images/logo.svg') }}" alt=Logo courses-pagespeed-url-hash=3852796712 onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
            </a>
                        ...
                        <div class="table-responsive">
                            <table class="table" style="width: 1360px !important;" >
                                ...
                                @foreach($courses as $course)
                                    <tr>
                                    <td> <a href="/{{$course->slug}}">
							                        <img src="{{ asset('images/' . $course->image_path)}}" style="width:130px; height:120px;">
						                              </a>
                                        </td> 
                                        <td>{{ $course->id}}</td> 
                                        <td>{{ $course->title}}</td> 
                                        ...
                                        <td>{{ $course->level}}</td>
                                        <td>{{ $course->price}}</td>
                                        <td>{{$course->mentor->full_name}}</td>
                                        <td>{{$course->category->name}}</td>
                              
                              
 
                                        <td>
                                            <a  href="/admin/courses/{{$course->id}}/edit" title="View Student">
                                              <button class="login">
                                                <i  aria-hidden="true"></i> Edit </button></a>
 
                                            <form action="/admin/courses/{{$course->id}}" method="POST" accept-charset="UTF-8" style="display:inline">
    ...
    <div class=row>
      <div class="col-xl-3 col-lg-3 col-md-6">
        <div class=footer-widget>
          <a class = "logo" href="/" >
            <img  src="{{ asset('/assets/images/logo.svg') }}" alt="" courses-pagespeed-url-hash=3852796712 onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
          </a>
