...
<div class="account-login section">
  ...
  <form method="POST" action="/admin/courses/{{$cource->id}}" enctype="multipart/form-data" >
  @method('PATCH')	
          @csrf
        ...
        <div class="formbold-textarea">
          <label for="message" class="formbold-form-label"> Content </label>
            <textarea
                ...
                id="message"
                placeholder="Write course content..."
                class="formbold-form-input">{{ $cource->content}}</textarea>
            @endif
            @error('content')
              <p id="error" class="text-red-500 text -xs mt-1" style="font-size:13px;"  >{{$message}}</p>
             @enderror
         ...
         @if ($errors->has('description'))
            ...
            <textarea
                ...
                id="message"
                placeholder="Write course description..."
                class="formbold-form-input">{{ $cource->description}} </textarea>
            @endif
            @error('description')
          <p id="error" class="text-red-500 text -xs mt-1" style="font-size:13px;">{{$message}}</p>
         @enderror
        ...
        <div class="formbold-input-flex">
        <div class="form-group">
        <label for="message" class="formbold-form-label"> Select Mentor </label>
      ...
      <div class="formbold-form-step-3">
        ...
        <p style="margin-top:-20px;margin-left:-680px" >Current course image </p>
            <img src="{{ asset('images/' . $cource->image_path)}}" style="width:135px; height:180px; 
        margin-left:-680px; margin-top:5px;height:120px; border-radius:100px;">
              
        <button  class="formbold-btn" style="margin-left:530px; margin-top:-70px;";  >Update</button>
    </form>
  </div>
</div>
