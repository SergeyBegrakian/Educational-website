					...
					<nav class="navbar navbar-expand-lg">
						...
						<div class="collapse navbar-collapse sub-menu-bar" id=navbarSupportedContent>
							<ul id=nav class="ml-auto navbar-nav">
								...
								<li >
									<a href="/profile" class="account" >  Welcome <?php echo e(auth()->user()->name); ?>  </a>
								</li>
								<li>
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				...
				<div class="single-course wow fadeInUp" data-wow-delay=.2s>
					<div class=course-img>
						...
						<a href="/<?php echo e($courses->slug); ?>">
							<img src="<?php echo e(asset('images/' . $courses->image_path)); ?>" alt="" data-pagespeed-url-hash=1975346514 onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
						</a>
					</div>
				
					<div class=course-info>
						<h4>
							<a href="<?php echo e('/slug'); ?>"><?php echo e($courses->title); ?></a>
						</h4>
	...
	<div class=container>
		...
		<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
				<a href="/category/<?php echo e($category->slugg); ?>" class="d-block category-wrapper">
...
<section id=mentors class="team-area pt-170 pb-140">
	<div class=container>
		...
		<div class=row>
			<?php $__currentLoopData = $mentors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mentors): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class=single-team>
					<div class=team-img>
			
						<img src="<?php echo e(asset('images/' . $mentors->image_path)); ?>"  alt="" data-pagespeed-url-hash=3470830167 onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
					...
					<div class=team-info>
						<h4 > <?php echo e($mentors->full_name); ?></h4>
						<p class='fas fa-graduation-cap' ><?php echo e($mentors->profession); ?></p> <br></br>
						<p class="fa fa-envelope"><?php echo e($mentors->email); ?></p> <br></br>
						<p class="fa fa-phone" ><?php echo e($mentors->phone_number); ?></p>
					</div>
		...
		<div class=row>
			...
			<div class="col-xl-7 col-lg-7">
				<div class=contact-form-wrapper>
					<form action="<?php echo e(route('contactsubmit')); ?>" method="POST">
						<?php echo csrf_field(); ?>
...
<?php /**PATH /Users/sergeybegrakyan/MY_PROJECT/resources/views/welcome.blade.php ENDPATH**/ ?>