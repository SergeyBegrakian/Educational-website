        ...
        <div class=col-xl-12>
          <nav class="navbar navbar-expand-lg">
            <a class=navbar-brand href="/">
              <img id=logo  src="<?php echo e(asset('/assets/images/logo.svg')); ?>" alt=Logo data-pagespeed-url-hash=3852796712 onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
            </a>
                        ...
                        <div class="table-responsive">
                            <table class="table" style="width: 1360px !important;" >
                                ...
                                <?php $__currentLoopData = $mentors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mentor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                    <td> <a href="/<?php echo e($mentor->slug); ?>">
							                        <img src="<?php echo e(asset('images/' . $mentor->image_path)); ?>" style="width:135px; height:120px; border-radius:100px;">
						                              </a>
                                        </td> 
                                        <td><?php echo e($mentor->full_name); ?></td> 
                                        <td><?php echo e($mentor->profession); ?></td> 
                                        <td><?php echo e($mentor->email); ?></td>
                                        <td><?php echo e($mentor->phone_number); ?></td>
 
                                        <td>
                                            <a  href="/admin/mentors/<?php echo e($mentor->id); ?>/edit" title="View Student">
                                              <button class="login">
                                                <i  aria-hidden="true"></i> Edit </button></a>
 
                                            <form action="/admin/mentors/<?php echo e($mentor->id); ?>" method="POST" accept-charset="UTF-8" style="display:inline">
    ...
    <div class=row>
      <div class="col-xl-3 col-lg-3 col-md-6">
        <div class=footer-widget>
          <a class = "logo" href="/" >
            <img  src="<?php echo e(asset('/assets/images/logo.svg')); ?>" alt="" data-pagespeed-url-hash=3852796712 onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
          </a>
...
<?php /**PATH /Users/sergeybegrakyan/MY_PROJECT/resources/views/mentors/list.blade.php ENDPATH**/ ?>